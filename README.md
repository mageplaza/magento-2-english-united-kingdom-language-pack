## Magento 2 English United Kingdom Language Pack
...
```
unzip master.zip app/i18n/Mageplaza/en_gb
```
...
Unzip the compressed file and upload file `en_GB.zip` into `app/i18n/mageplaza/en_GB/en_GB.csv`
